...
class PMTTruthFromTruth:
    ...
    def __init__(self, 
                 pa_truth: pa.Table,
                 vertex_columns: List[str] = ['pos_x_GNHighestEDaughter', 'pos_y_GNHighestEDaughter', 'pos_z_GNHighestEDaughter'],
                 direction_columns: List[str] = ['dir_x_GNHighestEDaughter', 'dir_y_GNHighestEDaughter', 'dir_z_GNHighestEDaughter'],
        ...
        self.post_vertex_intra_IceCube_segment_column = post_vertex_intra_IceCube_segment_column
    ...
    def _compute_post_vertex_intra_IceCube_segment(self) -> pa.Table:
        ...
        return pa.Table.from_pydict({
            ...
            self.post_vertex_intra_IceCube_segment_column: pa.array(distances, type=pa.float32())
        })
